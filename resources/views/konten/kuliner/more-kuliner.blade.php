                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            @foreach ($allKuliner as $kuliner)
                                <h1 class="display-2 text-white">{{ $kuliner->nama_kuliner }}</h1>
                    ...
                    <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
                        <div class="card card-profile shadow">
                            ...
                            <div class="card-body pt-0 pt-md-4">
                                ...
                                <div class="card-profile-image">
                                    <a href="#">
                                        <img src="{{ asset('storage/images') }}/{{ $kuliner->gambar }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <a href="{{ route('kuliner') }}" button type="submit" class="btn btn-primary">
                                            Kembali
                                        </a>
                                    </div>
                                </div>
