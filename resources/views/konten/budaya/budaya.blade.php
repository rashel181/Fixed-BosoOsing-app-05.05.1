        ...
        <main>
            ...
            <header class="container bg-light p-5" style="border-radius: 20px;">
                ...
                <p class="col-12 text-center">
                    Banyak sekali Budaya khas Banyuwangi, kabupaten yang dijuluki sebagai Sunrise of Java ini banyak sekali
                    memiliki ciri khas terutama budaya yang sangat terkenal dan sudah dikenal oleh tingkat internasional
                </p>
            </header></br>
                        ...
                        <td>
                            ...
                            <div id="tm-gallery-page" class="tm-gallery-page" style="border-radius: 10px">
                                <article class="p-2 tm-gallery-item">
                                    <figure>
                                        <img src="{{ asset('storage/images') }}/{{ $budaya->gambar }}" alt="Image"
                                        ...
                                        <figcaption>
                                            ...
                                            <a href="{{ route('more.budaya', $budaya->id) }}"
