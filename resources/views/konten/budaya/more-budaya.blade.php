                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            @foreach ($allbdy as $budaya)
                                <h1 class="display-2 text-white">{{ $budaya->nama_budaya }}</h1>
                    ...
                    <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
                        <div class="card card-profile shadow">
                            ...
                            <div class="card-body pt-0 pt-md-4">
                                ...
                                <div class="card-profile-image">
                                    <a href="#">
                                        <img src="{{ asset('storage/images') }}/{{ $budaya->gambar }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <a href="{{ route('budaya') }}" button type="submit" class="btn btn-primary">
                                            Kembali
                                        </a>
                                    </div>
                                </div>
